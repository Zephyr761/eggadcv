_base_ = [
    '/mnt/hcufs/home/youjunqi/VAD/adzoo/vad/configs/datasets/custom_nus-3d.py',
    '/mnt/hcufs/home/youjunqi/VAD/adzoo/vad/configs/_base_/default_runtime.py'
]
#
plugin = True
...
class_names = [
    'car', 'ped', 'bike', 'traffic_cone', 'barrier', 'czone_sign'
]
num_classes = len(class_names)

# map has classes: divider, ped_crossing, boundary
map_classes = ['boundaries','crosswalks','stop_polygons']
map_num_vec = 100
...
dataset_type = 'VADNuplanDataset'
data_root = '/mnt/hcufs/home/youjunqi/VAD/data/'
...
data = dict(
    ...
    train=dict(
        type=dataset_type,
        data_root=data_root,
        ann_file=data_root + 'mini_infos_train.pkl',
    ...
    val=dict(type=dataset_type,
             data_root=data_root,
             pc_range=point_cloud_range,
             ann_file=data_root + 'mini_infos_val.pkl',
